      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/4.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/4.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Victus by HP Ryzen 5 5600H 16.1-inch(40.9 cm)</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.67,990</li>
              </ul>
            </div>
            <p>Victus by HP Ryzen 5 5600H 16.1-inch(40.9 cm) FHD Gaming Laptop (8GB RAM/512GB SSD/4GB GTX 1650 Graphics/Flicker Free Display/Windows 10/MS Office/Mica Silver/2.48 Kg), 16-e0075AX
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Processor: 5th Gen AMD Ryzen 5 5600H (3.3GHz base clock speed, up to 4.2 GHz Max Boost Clock, 16MB L3 cache, 6 core, 12 threads)</li>
                <li>- Operating System:Pre-loaded Windows 10 Home with lifetime validity, Free upgrade to Windows 11* when available</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> ‎2 kg 480 g</li>
                <li><span>Dimensions</span>‎37 x 26.2 x 2.4 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Graphics & Networking: NVIDIA GeForce GTX 1650 (4 GB GDDR6 dedicated) | Realtek Wi-Fi 6 (2x2) and Bluetooth 5.2 combo (Supporting Gigabit data rate), MU-MIMO supported, Miracast Compatible
              </p>
            </div>
          </div>
