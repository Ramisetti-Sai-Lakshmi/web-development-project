      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/31.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/31.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Right Plus 10" LED Ring Light with Tripod Stand for YouTube Photo-Shoot Video Shoot Live Stream | Instagram | Selfie | Photography | vlogging | Makeup | iPhone | Android</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.899</li>
              </ul>
            </div>
            <p>Right Plus 10" Inch LED Ring Light | Multicolour Lights | Makeup & Vlogging | Videography | Mobile Phone | All Cameras | Compatible with iPhone/Android | Selfie | YouTube | Photo-Shoot | Video Shoo
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-COMFIRTABLE FOR INDOOR & OUTDOOR : Light weight and easy to carry around. You can attach it to any ring light holder. The mobile holder can be adjusted as well.</li>
                <li>-3 Light Modes : The ring light is having White Warm white and Yellow option to select as per the requirement. You can also increase and dim the ring light as per the requirement.</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 420g</li>
                <li><span>Dimensions</span>‎‎‎‎‎26 x 26 x 3 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>MULTI MOUNT COMPATIBLE : Straight out of the box, Ring Light and Master Mount S are the perfect pair for any occasion. But don’t let that stop you from exploring your options.              </p>
            </div>
          </div>
