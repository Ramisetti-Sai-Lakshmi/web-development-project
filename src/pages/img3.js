      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/img3.jpg" data-zoom-image="assets/images/zoom/img3.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Redmi 9 (Carbon Black, 4GB RAM, 64GB Storage)2.3GHz Mediatek</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.9,499</li>
              </ul>
            </div>
            <p>13+2MP Rear camera with AI Portrait, AI scene recognition, HDR, Pro mode | 5MP front facing camera
            </p>
            <div className="pro-details-list">
              <ul>
                
                <li>- Memory, Storage & SIM: 4GB RAM | 64GB internal memory 
                </li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 194 g</li>
                <li><span>Dimensions</span>16.5 x 0.9 x 7.7 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Dual SIM;GPS;Music Player;Video Player;;Proximity sensor;Accelerometer;Ambient light sensor;Fingerprint sensor;E-mail
              </p>
            </div>
          </div>
