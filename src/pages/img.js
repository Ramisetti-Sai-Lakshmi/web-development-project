      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/img.jpg" data-zoom-image="assets/images/zoom/img.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Oneplus nord 2 5g blue haze (8gb ram 128gb storage)</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.29,999</li>
              </ul>
            </div>
            <p>Camera: Sony IMX 766 50MP+8MP+2MP AI Triple Camera with 4K@30FPS|1080p video at 30/60 fps | 32MP Front camera with 1080p video at 30/60 fps | Super Slow Motion: 1080p video at 120 fps, 720p video at 240 fps | Time-Lapse: 1080p 120fps;720p 240fps
            ...
            <div className="pro-details-list">
              <ul>
                <li>- Display: 6.43-inch, 90Hz Fluid AMOLED display</li>
                <li>- Resolution: 2400 x 1080 pixels | 410 PPI | Aspect</li>
                <li>- Ratio: 20:9 | Support sRGB, Display P3</li>
                <li>- Memory, Storage & SIM: 8GB RAM | 128GB internal memory on UFS 3.1 storage system.
                </li>
                <li>- Connectivity: Dual SIM (nano + nano) | Currently supports dual 5G SIM Cards</li>
                <li>- Operating System: OxygenOS 11.3 operating system based on Android 11</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 190 g</li>
                <li><span>Dimensions</span>15.9 x 0.8 x 7.3 cm</li>
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <div className="section-title">
            ...
            <p>6 other products in the same category:</p>
          </div>
          {/* Section Title */}
        </div>
      </div>
