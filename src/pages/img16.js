      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/14.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/14.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Portronics My Buddy Plus..</h2>
            ...
            <p>Portronics My Buddy Plus POR-704 Adjustable/Portable/Foldable Multipurpose Laptop Cooling Table
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Elegant Portable: Very attractive design and finish. Legs can be folded completely to make it highly portable</li>
                <li>-Strong and adjustable: Vertical extension of legs and angular adjustments (0-30 degrees) of top. It has soft notches given on one side of flat-top to prevent things from rolling down when tilted.</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 1.5Kg</li>
                <li><span>Dimensions</span>‎‎52 x 30 x 0.9 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Compatible: Size and strength ensures that all laptop models can be mounted on it. A separate place to keep mouse with mouse-pad
              </p>
            </div>
          </div>
