      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/9.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/9.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Logitech G335 Wired Gaming Headset, with Flip to Mute Microphone</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.6,795</li>
              </ul>
            </div>
            <p>Logitech G335 Wired Gaming Headset, with Flip to Mute Microphone, 3.5mm Audio Jack, Memory Foam Earpads, Lightweight, Compatible with PC, Playstation, Xbox, Nintendo Switch - Black
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Lightweight Design: Weighing in at only 8.5 oz (240 g), G335 is smaller and lighter than the G733, features a suspension headband to help distribute weight and is adjustable for a customized fit
                </li>
                <li>- Plug and Play: Quickly jump into your game and simply connect with the 3.5 mm audio jack; these colorful headphones are compatible with PC, laptop, gaming consoles, and select mobile devices</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 222 g</li>
                <li><span>Dimensions</span>‎18.9 x 18 x 7.9 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Impressive Sound: With 40 mm neodymium drivers, the G335 computer gaming headset delivers crisp, clear stereo sound that makes your game come alive
              </p>
            </div>
          </div>
