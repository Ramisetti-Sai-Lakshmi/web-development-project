      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/2.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/2.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>ASUS VivoBook 15 (2020) Intel Core i3</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.38,490</li>
              </ul>
            </div>
            <p>ASUS VivoBook 15 (2020) Intel Core i3-1005G1 10th Gen, 15.6"(39.62cms) FHD Thin and Light Laptop (4GB RAM/1TB HDD/Windows 10/Integrated Graphics/Slate Grey/1.8 Kg), X515JA-EJ301T
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Processor: 10th Gen Intel Core i3-1005G1, 1.2 GHz Base Speed, Up to 3.4 GHz Max Turbo Speed, 2 cores, 4 Threads, 4MB Cache</li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 1.8 Kg</li>
                <li><span>Dimensions</span>‎23.5 x 36 x 2 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>ASUS INDIA PRIVATE LIMITED, 402, Supreme chambers, 17/18, Shah Industrial Estate, Veer Desai Road, Andheri (west), Mumbai 400053, India
              </p>
            </div>
          </div>
