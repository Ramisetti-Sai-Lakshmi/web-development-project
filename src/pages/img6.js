          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/3.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/3.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.43,339</li>
              </ul>
            </div>
            <p>Lenovo IdeaPad Slim 5 AMD Ryzen 7 4700U 14" (35.56cm) FHD IPS Thin & Light Laptop (8GB/512GB SSD/Windows 10/MS Office/Backlit Keyboard/Fingerprint Reader/Graphite Grey/1.39Kg), 81YM002TIN
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Processor: AMD Ryzen 7 4700U Processor; Base speed: 2.0Ghz, Max Speed: 4.1GHz, 8 Cores, 8 Threads, 8MB Smart Cache</li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 1.6 Kilograms</li>
                <li><span>Dimensions</span>‎32.1 x 21.1 x 2 cm</li>
