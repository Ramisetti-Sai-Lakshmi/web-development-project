      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/15.png" data-zoom-image="assets/images/product-image/electronic/zoom/15.png" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Bajaj Surge & Spike Guard 4Way with 2meter Fire Retardant Cable</h2>
            ...
            <p>Bajaj Surge & Spike Guard 4Way with 2meter Fire Retardant Cable
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Best in class(160Joules) Spike surge protection
                </li>
                <li>-Bajaj Quality Assuranace and Two Year Warrantee2 meter of Heavy Duty Fire Retardant Cable</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 320g</li>
                <li><span>Dimensions</span>‎‎‎34.2 x 11.8 x 5.8 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>2 meter of Heavy Duty Fire Retardant Cable
              </p>
            </div>
          </div>
