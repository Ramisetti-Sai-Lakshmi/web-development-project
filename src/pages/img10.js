      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/10.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/10.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Logitech G PRO Wireless Gaming Mouse</h2>
            ...
            <p>Logitech G Pro Wireless Gaming Mouse with Esports Grade Performance
            </p>
            <div className="pro-details-list">
              <ul>
                <li>- Designed as per the latest market trends
                </li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 81.65 g</li>
                <li><span>Dimensions</span>‎3.99 x 6.35 x 12.5 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>This product will be an excellent pick for you
              </p>
            </div>
          </div>
