      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/11.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/11.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>ViewSonic ID1330 13.3 Inch Portable 1080p Drawing Pen Display Tablet</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.30,500</li>
              </ul>
            </div>
            <p>ViewSonic ID1330 13.3 Inch Portable 1080p Drawing Pen Display Tablet with Battery Free Stylus Pen for Digital Writing, Graphic Design, Remote Teaching, Distance Learning Supports Windows, Mac, Android

            </p>
            <div className="pro-details-list">
              <ul>
                <li>- WORKS WITH DIFFERENT SOFTWARE AND OPERATION SYSTEMS: The ID1330 works seamlessly with various programs such as myViewBoard and Adobe Photoshop for an intuitive writing, drawing and annotation experience anywhere. Compatible with Windows 7 or later, Mac OS 10.11 or later
                </li>
                <li>- ACCURATE HANDWRITING: An interactive stylus pen delivers up to 8,192 levels of pressure sensitivity and a 250 pps response rate for an incredibly natural writing and drawing experience</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Resolution</span>1920 x 1080 pixels</li>
                <li><span>Dimensions</span>294×165mm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>BATTERY-FREE PEN: The battery-free pen features a pen tip with a lifespan of up to 150,000 taps. Three extra pen tips are included.
              DIGITIZE YOUR WORK: Save your work. Whether you’re taking notes or drawing sketches, the ID1330 helps you effortlessly save and edit photos, notes and art.
              </p>
            </div>
          </div>
