      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/32.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/32.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2> CAMSIR Fujifilm Instax Mini 8/Mini 8+/Mini 9 Crystal Case Crystal Camera Case With Adjustable Rainbow Shoulder Strap for Fujifilm Instax Mini 8/Mini 8+/Mini 9 Instant</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.699</li>
              </ul>
            </div>
            <p>CAMSIR Fujifilm Instax Mini 8/Mini 8+/Mini 9 Crystal Case Crystal Camera Case With Adjustable Rainbow Shoulder Strap for Fujifilm Instax Mini 8/Mini 8+/Mini 9 Instant Camera, Transparent
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-No need to take out the camera when taking photo, this fujifilm instax mini 8 / mini 8+ / mini 9 case helps capture the perfect photo every time.</li>
                <li>-Crystal clear with colorful strap suitable for any location or any occasion, being convenient and helpful to be used for outdoor or indoor, the strap is brilliant, removable and makes carrying the camera easy.</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span>  81.65g</li>
                <li><span>Dimensions</span>‎‎‎‎‎19.99 x 14 x 19.99 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Top-quality, compact, lightweight and extremely durable material, protecting your camera from dust, scratches and damages, the camera is safe in it's new home
Super adorable and stain resistant, after the crystal case is used for a long time, it will looks like a new one after wiping with a towel</p>
            </div>
          </div>
