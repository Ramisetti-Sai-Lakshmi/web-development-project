      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/1.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/1.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Fujitsu UH-X 11th Gen Intel Core i5</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.74,990</li>
              </ul>
            </div>
            <p>Processor: 11th Gen Intel Tiger Lake Core i5-1135G7 | Speed: 2.4 GHz (Base) - 4.2 GHz (Max) | 4 Cores | 8MB Cache
            </p>
            <div className="pro-details-list">
              <ul>
               
                <li>- Memory, Storage : 8GB RAM | 512GB SSd
                </li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 878 g</li>
                <li><span>Dimensions</span>30.7 x 19.7 x 1.6 cm</li>
