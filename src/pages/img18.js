      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/29.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/29.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Canon Store Canon IVY CLIQ 2 Instant Camera Printer, Mini Photo Printer, Petal Pink (Matte)</h2>
            ...
            <p>Canon IVY CLIQ 2 Instant Camera Printer, Mini Photo Printer, Petal Pink (Matte)
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-Easy to use Instant Camera Printer to capture and print your favorite moments.
                </li>
                <li>-Every print is a sticker! Each 2”x3” photo has a Peel & Stick adhesive backing.</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 9.6 ounces
</li>
                <li><span>Dimensions</span>‎‎‎	4.8 x 3.2 x 0.9 inches</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>No ink needed! Uses ZINK (Zero Ink) technology to create prints that are Smudge-Free and Water/Tear-Resistant.
              </p>
            </div>
          </div>
