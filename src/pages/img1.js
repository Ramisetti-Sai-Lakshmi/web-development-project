      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/img1.jpg" data-zoom-image="assets/images/zoom/img1.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Samsung Galaxy M31s (Mirage Blue, 6GB RAM, 128GB Storage)</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.15,499</li>
              </ul>
            </div>
            <p>Quad camera setup - 64MP (F1.8) main camera + 12MP (F2.2) ultra wide camera + 5MP (F2.4) depth camera + 5MP (F2.4) macro camera | 32MP (F2.2) front camera
            </p>
            <div className="pro-details-list">
              <ul>
                <li>- Model name:Samsung galaxy</li>
                <li>- Form factor:Smartphone</li>
                <li>- Brand : Samsung</li>
                <li>- Memory, Storage Capacity:  128GB
                </li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Inch</span> 6.5</li>
                <li><span>Resolution</span>1080x2400 pixels</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Android v10.0 operating system with 1.7GHz+2.3GHz Exynos 9611 octa core processor
              </p>
            </div>
          </div>
