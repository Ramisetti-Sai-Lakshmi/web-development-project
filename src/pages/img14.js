      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/12.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/12.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Artis PS-600VA 600VA Line Interactive UPS</h2>
            ...
            <p>Artis PS-600VA 600VA Line Interactive UPS for Personal Computers , Desktop PCs, Laptops, Routers, Networking Devices and Gaming Consoles
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-600VA/360W Desktop PC UPS. Generator Compatible. Wide input Range: 140-300V. With Cold Start Function & AVR which regulates voltage automatically.
                </li>
                <li>- Heavy Duty 7AH battery, 3 Output Sockets, connect upto 3 devices. With a maximum backup of 45 minutes* depending on load/Devices connected. (Max backup with PC+Monitor+Router is 15-20 mins)</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 4.25 Kg</li>
                <li><span>Dimensions</span>‎2.7 x 9 x 14 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>Micro-controller insures high reliability. Simulated Sine wave Output., Compact Size & Light weight. Extremely Silent operation. Blazing fast transfer time of just 2-4 milliseconds! Fast Charging: 4 Hours for 90% charge.
              </p>
            </div>
          </div>
