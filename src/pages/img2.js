      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/img2.jpg" data-zoom-image="assets/images/zoom/img2.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Redmi 9A (Sea Blue 2GB RAM 32GB Storage) |2GHz Octa-core Helio G25</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.6,999</li>
              </ul>
            </div>
            <p>13MP rear camera with AI portrait, AI scene recognition, HDR, pro mode | 5MP front camera, Contrast: 1500:1
            </p>
            <div className="pro-details-list">
              <ul>
                
                <li>- Memory, Storage & SIM: 2GB RAM | 32GB internal memory 
                </li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Inch</span> 6.53</li>
                <li><span>Resolution</span>1600 x 720 pixels</li>
