      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/img4.jpg" data-zoom-image="assets/images/zoom/img4.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>OnePlus Nord CE 5G (Charcoal Ink, 6GB RAM, 128GB Storage</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.22,999</li>
              </ul>
            </div>
            <p>64MP+8MP+2MP triple rear camera with 1080p video at 30/60 fps, 4k 30 fps | 16MP front camera with 1080p video at 30/60 fps.
            </p>
            <div className="pro-details-list">
              <ul>
                <li>- Display: 6.43-inch, 90Hz Fluid AMOLED display</li>
                
                <li>- Memory, Storage & SIM: 6GB RAM | 128GB internal memory on UFS 2.1 storage system.
                </li>
                <li>- Connectivity: Wifi 5G USB</li>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 170 g</li>
                <li><span>Dimensions</span>15.9 x 0.8 x 7.4 cm</li>
