      ...
      <div className="row">
          ...
          <div className="product-details-img product-details-tab">
            <div className="zoompro-wrap zoompro-2">
              <div className="zoompro-border zoompro-span">
                <img className="zoompro" src="assets/images/product-image/electronic/30.jpg" data-zoom-image="assets/images/product-image/electronic/zoom/30.jpg" alt />
              </div>
            </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12">
          <div className="product-details-content">
            <h2>Ring Light with Tripod Stand - 12" Inches Big Professional LED Ring Light with Stand for Photo and Video with 7 Feet Stand Compatible with Camera and Smartphones for..</h2>
            ...
            <div className="pricing-meta">
              <ul>
                <li className="old-price not-cut">Rs.14,029</li>
              </ul>
            </div>
            <p>mobimint 12 inch Camera LED Ring Light with Tripod Stand and Double Phone Holders Compatible with All Smartphones for Streaming, Makeup, Selfie Photography
            </p>
            <div className="pro-details-list">
              <ul>
                <li>-【Dimmable Ring Light】:- 18" Ring Light features 3 light colors (Warm, Cool White, Daylight) and 11 levels brightness in each color, 33 options in total. You can choose any option in between if there’s a perfect setting.</li>
                <li>【Adjustable & Stable Tripod】:- Extending from 16" to 50", and tripod legs unfold up to 30" wide, the stable tripod can be adjusted to any height within as needed, short enough to stand on tabletop, tall enough to fit your height.</li>
              </ul>
            </div>
        ...
        <div className="tab-content description-review-bottom">
          <div id="des-details2" className="tab-pane active">
            <div className="product-anotherinfo-wrapper">
              <ul>
                <li><span>Weight</span> 110 Grams
</li>
                <li><span>Dimensions</span>‎‎‎		‎3 x 3 x 3 cm</li>
          ...
          <div id="des-details1" className="tab-pane">
            <div className="product-description-wrapper">
              <p>【Endless Lighting Angle】:- 3-way pan head with a convenient handle allows for tilt and swivel motion; portrait or landscape options. Making it easy to target the ring light to your subject at any angle, perfect for live streaming, video calling, flat lay, taking selfies or more.
              </p>
            </div>
          </div>
